                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(15.2, 10, 15, 10),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 2.5, 0.2, 2.5),
                                  child: Text(
                                    'Figma',
                                    style: GoogleFonts.getFont(
                                      'Open Sans',
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: AssetImage(
                                              'assets/images/touch_target_1.gif',
                                            ),
                                          ),
                                        ),
                                        child: Container(
