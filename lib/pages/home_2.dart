    ...
    Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(24, 0, 24, 67),
              child: Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(15.5, 12.5, 18.5, 12.5),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                  ...
                  Container(
                    ...
                    child: Container(
                      padding: EdgeInsets.fromLTRB(0, 190, 0, 189),
                      child: Text(
                        'conteúdo',
                        style: GoogleFonts.getFont(
                          'Open Sans',
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: SizedBox(
                                    ...
                                    height: 26,
                                    child: SvgPicture.asset(
                                      'assets/vectors/dictation_5_x2.svg',
                                    ),
                                  ),
                                ),
                              ],
