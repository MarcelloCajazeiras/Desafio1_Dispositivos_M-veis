                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Container(
                            padding: EdgeInsets.fromLTRB(15.2, 11, 18.5, 11),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 1.5, 0.2, 1.5),
                                  child: Text(
                                    'Figma',
                                    style: GoogleFonts.getFont(
                                      'Open Sans',
                                ...
                                Container(
                                  margin: EdgeInsets.fromLTRB(0, 2, 0, 2.5),
                                  width: 17.5,
                                  height: 17.5,
                                  child: SizedBox(
                                    width: 17.5,
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: SizedBox(
                                        ...
                                        height: 26,
                                        child: SvgPicture.asset(
                                          'assets/vectors/dictation_6_x2.svg',
                                        ),
                                      ),
                                    ),
                                  ],
