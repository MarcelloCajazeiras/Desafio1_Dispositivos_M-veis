    ...
    Container(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              margin: EdgeInsets.fromLTRB(24, 0, 24, 64),
              child: SizedBox(
                height: 655,
                child: Stack(
                  children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Container(
                              padding: EdgeInsets.fromLTRB(15.2, 11, 17, 11),
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
